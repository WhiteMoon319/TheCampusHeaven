...
define config.name = _("TheCampusHeaven")
...
define build.name = "TheCampusHeaven"
...
#define config.main_menu_music = "main_bgm.ogg"
...
define config.save_directory = "TheCampusHeaven-1784442798"
...
init python:
    ...
    build.classify("game/gui/**.jpg", "gui")
